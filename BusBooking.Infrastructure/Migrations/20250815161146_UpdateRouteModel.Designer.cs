...
namespace BusBooking.Infrastructure.Migrations
{
    ...
    [Migration("20250815161146_UpdateRouteModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusBooking.Domain.Entities.Route", b =>
                {
                    b.HasOne("BusBooking.Domain.Entities.City", "DestinationCity")
                        .WithMany()
                        .HasForeignKey("DestinationCityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BusBooking.Domain.Entities.City", "SourceCity")
                        .WithMany()
